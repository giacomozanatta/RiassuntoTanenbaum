...
\subsubsection{Prestazioni di EthernetSupponiamo una probabilità costante di ritrasmissione ad ogni slot. Se ogni stazione trasmette in un intervallo con contesa con probabilità p, allora la probabilità A che qualche stazione acquisista il controllo del canale in quell'intervallo è:
\begin{equation}
 A = kp(1-p)^{k-1}
\end{equation}
